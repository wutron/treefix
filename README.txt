...
Usage: treefix [OPTION] <gene tree>
...
Options:
  Input/Output:
    ...
    -n <new tree file extension>, --newext=<new tree file extension>
                        new tree file extension (default: ".fixed.tree")
  ...
  Search Options:
    ...
    --freconroot=<fraction reconroot>
                        fraction of search proposals to reconroot
...
See examples/analyze-fungi-fam.sh for an example of how to use TreeFix.
